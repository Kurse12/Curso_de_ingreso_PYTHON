...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        sueldo_inic = float(self.txt_importe.get())
        descuento_jubilacion = float(self.txt_descuento.get())
        sueldo_desc = sueldo_inic * descuento_jubilacion /100
        sueldo_final = sueldo_inic - sueldo_desc
        alert("Su sueldo con descuentos es:", sueldo_final)
